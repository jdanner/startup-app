...
import projectreadLogo from '../assets/images/projectread.webp';
import reforgeLogo from '../assets/images/reforge.svg';
import schoolaiLogo from '../assets/images/schoolai.png';
import sparkspaceLogo from '../assets/images/sparkspace.svg';
...
export const companies = {
  ...
  "ProjectRead.ai": {
    logo: projectreadLogo,
    description: "AI-powered reading assessment and instruction platform helping teachers identify and support struggling readers.",
    website: "https://projectread.ai",
    jobsUrl: "https://projectread.ai"
  },
  "Reforge": {
    logo: reforgeLogo,
  ...
  "SparkSpace.ai": {
    logo: sparkspaceLogo,
    description: "AI-powered platform helping K-12 schools optimize their physical spaces for better learning outcomes.",
    website: "https://sparkspace.ai",
    jobsUrl: "https://sparkspace.ai"
  },
  "Stepful": {
    logo: stepfulLogo,
